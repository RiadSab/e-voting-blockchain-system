package com.evote.backend.vote.entity;

import com.evote.backend.shared.enums.VoteStatus;
import com.evote.backend.shared.base.BaseEntitySeq;
...
@Table(name = "votes",
    indexes = {
            ...
            @Index(columnList = "transaction_hash", name = "idx_votes_tx", unique = true),
